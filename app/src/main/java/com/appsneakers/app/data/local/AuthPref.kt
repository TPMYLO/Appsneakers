package com.appsneakers.app.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appsneakers.app.data.model.ActionState
import com.appsneakers.app.data.model.AuthUser
import com.appsneakers.app.util.getObject
import com.appsneakers.app.util.putObject
...
class AuthPref (val context:Context){
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser>{
        ...
        return if(user == null){
            ...
            ActionState(message = "Email atau Passwoard Anda Salah", isSuccess = false)
        }
    }
    ...
    suspend fun register(user: AuthUser):ActionState<AuthUser>{
        return if (user.email.isBlank() || user.password.isBlank()){
            ...
            authUser = user
            ActionState(user, message = "Anda Berhasil Melakukan Pendaftaran")
        }
    }
